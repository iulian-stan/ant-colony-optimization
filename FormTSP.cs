...
namespace TSP
{
    public partial class FormTsp : Form
    {
        ...
        private readonly List<int> _currentPath = new List<int>();
        private readonly List<int> _optimalPath = new List<int>();
        private readonly Pen _penPath = new Pen(Color.FromArgb(64, 0, 255, 0), 4);
        private readonly Pen _penOptimal = new Pen(Color.FromArgb(64, 0, 0, 255), 4);
        private readonly List<Point> _points = new List<Point>();
        private readonly Random _rand = new Random();
        private Solver _solver;
        private double _cost;
        private readonly XmlSerializer _serializer = new XmlSerializer(typeof(List<Point>));
